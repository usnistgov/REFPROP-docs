...
2. Setting enthalpy and entropy to zero for the saturated liquid at -40 °
C (designated as ASHRAE).

3. Setting enthalpy to 200 kJ/kg and entropy to 1.0 kJ/(kg-K) for the saturated liquid at 0 °
C (designated as IIR).
